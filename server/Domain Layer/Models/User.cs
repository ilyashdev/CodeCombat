...
public class User
{
    public User(long telegramId, DateTime registerTime, DateTime subscriptionTime, ICollection<Content> myContent, ICollection<Content> favoriteContent, ICollection<Content> myUps, ICollection<Content> myDowns)
    {
